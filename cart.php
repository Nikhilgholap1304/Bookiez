...
if(isset($_POST['order'])){
   $message[] = 'Your Products Are Ordered and Soon will be reached to you !';
}
  ...
  <div class="products">
   ...
   ?>
      <form method="post" class="box" action="">
         ...
         <div class="price"><?php echo $fetch_product['price']; ?>rs/-</div>
...
<div class="shopping-cart">
   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td><?php echo $fetch_cart['price']; ?>rs/-</td>
            <td>
            ...
            <td><?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>rs/-</td>
   ...
   <div class="cart-btn">  
      <form action="" method="post">
      <button type="submit" name="order"><a href="checkout.php" name="order" class="btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">Checkout now</a></button>
      </form>
   </div>
